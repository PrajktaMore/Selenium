...
import objectrepository.PageFactoryElemnt;
...
public class PageFactoryLogin {
  ...
  public void login() {
	  ...
	  System.setProperty("webdriver.chrome.driver", "C:\\Apps\\ChromeDriver\\chromedriver.exe");
		...
		//Page Factory Elements is advanced class for POM Framework
		
		PageFactory.initElements(d1, PageFactoryElemnt.class);
		// As its class name is PageFactoryElemnt
		PageFactoryElemnt.emailid.sendKeys("aaa");
		PageFactoryElemnt.continue_button.click();
