...
public class LoginFunctionality {
  ...
  */
  ...
  //For static Methods direct elements can be taken
		
        Elements.emailid(d1).sendKeys("aaa");//As its elements class name is Elements
		
		Elements.continue_button(d1).click();	
